...
def jobName = 'zeebe-csv-exporter-DISTRO-maven-deploy'
def repository = 'zeebe-csv-exporter'
...
JAR="zeebe-csv-exporter-${RELEASE_VERSION}.jar"
...
./github-release release --user zeebe-io --repo zeebe-csv-exporter --tag ${RELEASE_VERSION} --name "Zeebe CSV Exporter ${RELEASE_VERSION}" --description ""
./github-release upload --user zeebe-io --repo zeebe-csv-exporter --tag ${RELEASE_VERSION} --name "${JAR}" --file "${JAR}"
./github-release upload --user zeebe-io --repo zeebe-csv-exporter --tag ${RELEASE_VERSION} --name "${CHECKSUM}" --file "${CHECKSUM}"
'''
